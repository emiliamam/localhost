...
$component = "
SELECT * FROM `component_classes`
";
$component_classes = mysqli_query($connect, $component);
//A
// printf(mysqli_num_rows($q));A
...
<!-- <canvas id="popChart" width="100" height="100"></canvas> -->
  ...
  Превышение нормы, проверьте класс!
                      ...
                      // $i = 1;
                      // while ($tableName = mysqli_fetch_row($component_classes)){
                        $table = "Параметры датчиков";
                             ...
                             <tbody>
                               ...
                               while ($output = mysqli_fetch_assoc($result)) {
                                 ...
                                 <tr>
                                   ...
                                   <td><?php echo $output['carbon_dioxide'] ?></td>
                       ...
                       <?php
                         ...
                         $table = "Техническая составляющая класса";
                            ...
                            <table class="table table-striped table-sm">
                              <thead>
                                <tr>
                                 ...
                                 <th scope="col">Количество парт</th>
                                 <th scope="col">Все колиество ламп</th>
                                 <th scope="col">Количество компьютеров</th>
                                </tr>
                              </thead>
                              <tbody>
                                ...
                                <?php
                                $result = mysqli_query($connect, "SELECT * FROM `component_classes`");
                                while ($output = mysqli_fetch_assoc($result)) {
                                  $num = $output['temp'];
                                  ...
                                  <tr>
                                    ...
                                    <td><?php echo $output['floor'] ?></td>
                                    <td><?php echo $output['number_desks'] ?></td>
                                    <td><?php echo $output['number_lights'] ?></td>
                                    <td><?php echo $output['number_computers'] ?></td>
